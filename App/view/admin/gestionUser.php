...
<header class="header-base header-admin">
  ...
  <section class="section-admin">
    <div class="div_main">
        ...
        <tbody>
          <?php foreach ($tabUser as $user) : ?>
            <tr>
              ...
              <td>
                <form method="post" action="index.php?entite=utilisateur&action=update&id=<?= $user['id_utilisateur']; ?>">
                  <button class="btn-admin btn-modifier">Modifier</button>
                </form>
              </td>
              <td>
                <form method="post" action="index.php?entite=utilisateur&action=delete&id=<?= $user['id_utilisateur']; ?>">
      ...
      <form class="form-btncreeCat" method="post" action="index.php?entite=admin&action=createUser">
        <button class="btn-admin btn-creeCat">Créer Utilisateur</button>
      </form>
